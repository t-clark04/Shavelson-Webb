...
```{r}
summary(aov(score ~ person*occasion + person*item + item*occasion, data = table3.8))
```
...
c. 
THE RESIDUAL MEAN SQUARES VALUE IS NOT CORRECT IN THE AOV OUTPUT, AND I CAN'T FIGURE OUT WHY!
